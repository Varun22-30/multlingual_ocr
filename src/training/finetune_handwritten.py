...
LANG_CODE = "te"
HANDWRITTEN_DIR = os.path.join(project_root, "data", "handwritten")
HANDWRITTEN_CSV = os.path.join(HANDWRITTEN_DIR, "labels_handwritten_fixed.csv")
...
OUTPUT_CKPT = os.path.join(
    ...
    "models",
    "telugu",
    "vit_lstm_te_best_handwritten_finetuned.pth",
)
...
def make_dataloaders():
    ...
    print(f"Handwritten samples: total={n_total}, train={n_train}, val={n_val}")
